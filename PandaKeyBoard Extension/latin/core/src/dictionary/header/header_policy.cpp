...
const char *const HeaderPolicy::VERSION_KEY = "version";
...
int HeaderPolicy::readVersion() const {
    return HeaderReadWriteUtils::readIntAttributeValue(&mAttributeMap, VERSION_KEY, 0);
}
