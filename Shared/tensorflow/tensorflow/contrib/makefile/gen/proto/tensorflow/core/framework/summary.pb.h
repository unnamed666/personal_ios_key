...
class SummaryMetadata : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.SummaryMetadata) */ {
 public:
  ...
  // repeated .tensorflow.SummaryMetadata.PluginData plugin_data = 1;
  int plugin_data_size() const;
  void clear_plugin_data();
  static const int kPluginDataFieldNumber = 1;
  const ::tensorflow::SummaryMetadata_PluginData& plugin_data(int index) const;
  ::tensorflow::SummaryMetadata_PluginData* mutable_plugin_data(int index);
  ::tensorflow::SummaryMetadata_PluginData* add_plugin_data();
  ::google::protobuf::RepeatedPtrField< ::tensorflow::SummaryMetadata_PluginData >*
      mutable_plugin_data();
  const ::google::protobuf::RepeatedPtrField< ::tensorflow::SummaryMetadata_PluginData >&
      plugin_data() const;
 ...
 private:
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::google::protobuf::RepeatedPtrField< ::tensorflow::SummaryMetadata_PluginData > plugin_data_;
  mutable int _cached_size_;
  friend struct protobuf_tensorflow_2fcore_2fframework_2fsummary_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
// repeated .tensorflow.SummaryMetadata.PluginData plugin_data = 1;
inline int SummaryMetadata::plugin_data_size() const {
  return plugin_data_.size();
}
inline void SummaryMetadata::clear_plugin_data() {
  plugin_data_.Clear();
}
inline const ::tensorflow::SummaryMetadata_PluginData& SummaryMetadata::plugin_data(int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.SummaryMetadata.plugin_data)
  return plugin_data_.Get(index);
}
inline ::tensorflow::SummaryMetadata_PluginData* SummaryMetadata::mutable_plugin_data(int index) {
  // @@protoc_insertion_point(field_mutable:tensorflow.SummaryMetadata.plugin_data)
  return plugin_data_.Mutable(index);
}
inline ::tensorflow::SummaryMetadata_PluginData* SummaryMetadata::add_plugin_data() {
  // @@protoc_insertion_point(field_add:tensorflow.SummaryMetadata.plugin_data)
  return plugin_data_.Add();
}
inline ::google::protobuf::RepeatedPtrField< ::tensorflow::SummaryMetadata_PluginData >*
SummaryMetadata::mutable_plugin_data() {
  // @@protoc_insertion_point(field_mutable_list:tensorflow.SummaryMetadata.plugin_data)
  return &plugin_data_;
}
inline const ::google::protobuf::RepeatedPtrField< ::tensorflow::SummaryMetadata_PluginData >&
SummaryMetadata::plugin_data() const {
  // @@protoc_insertion_point(field_list:tensorflow.SummaryMetadata.plugin_data)
  return plugin_data_;
}
