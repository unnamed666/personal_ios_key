...
#include <vector>
#include <climits>
#include "fstext/determinize-lattice.h" // ex: for LatticeStringRepository
#include "fstext/fstext-utils.h"
#include "lat/lattice-functions.h"  // ex: for PruneLattice
//#include "lat/minimize-lattice.h"   // for minimization  // ex
//#include "lat/push-lattice.h"       // for minimization  // ex
