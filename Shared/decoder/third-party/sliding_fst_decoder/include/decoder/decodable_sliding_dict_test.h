...
#ifndef DECODER_DECODABLE_SLIDING_DICT_TEST_H_
#define DECODER_DECODABLE_SLIDING_DICT_TEST_H_
#include <vector>
#include <fst/fst.h>
...
using namespace std;
namespace kaldi {
class DecodableSlidingDictTest : public DecodableInterface {

public:

	DecodableSlidingDictTest(const fst::SymbolTable *isym);
 virtual ~DecodableSlidingDictTest() {}
