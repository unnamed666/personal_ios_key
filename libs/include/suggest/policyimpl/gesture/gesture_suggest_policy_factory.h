...
class SuggestPolicy;
class GestureSuggestPolicy;
class GestureSuggestPolicyFactory {
 public:
    static void setGestureSuggestPolicyFactoryMethod(const GestureSuggestPolicy *(*factoryMethod)()) {
    ...
    static const SuggestPolicy *getGestureSuggestPolicy() {
        ...
        return (SuggestPolicy*) sGestureSuggestFactoryMethod();
    }

 private:
    DISALLOW_COPY_AND_ASSIGN(GestureSuggestPolicyFactory);
    static const GestureSuggestPolicy *(*sGestureSuggestFactoryMethod)();
};
} // namespace latinime
