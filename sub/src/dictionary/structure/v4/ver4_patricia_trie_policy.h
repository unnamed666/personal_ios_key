...
class Ver4PatriciaTriePolicy : public DictionaryStructureWithBufferPolicy {
 public:
    ...
    int getCodePointsAndReturnCodePointCount(const int wordId, const int maxCodePointCount,
            int *const outCodePoints, int initialCount, const WordIdArrayView prevWordIds, WordAttributes *const attributes) const;
    ...
    const WordAttributes getWordAttributesInContextForPredication(const WordIdArrayView prevWordIds,
                                                                  const int wordId,
    ...
    int getProbabilityOfWordForPredication(const WordIdArrayView prevWordIds, const int wordId) const;
 ...
 private:
    ...
    int getSecondWord(int targetWordId, WordIdArrayView prevWordIds, WordAttributes *const attributes)const;
};
} // namespace latinime
