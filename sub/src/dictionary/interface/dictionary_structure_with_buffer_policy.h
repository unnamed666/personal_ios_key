...
class DictionaryStructureWithBufferPolicy {
 public:
    ...
    virtual int getCodePointsAndReturnCodePointCount(const int wordId, const int maxCodePointCount,
            int *const outCodePoints, int initialCount, const WordIdArrayView prevWordIds, WordAttributes*const attributes) const = 0;
    ...
    virtual const WordAttributes getWordAttributesInContextForPredication(const WordIdArrayView prevWordIds,
                                                                          const int wordId,
    ...
    virtual int getProbabilityOfWordForPredication(const WordIdArrayView prevWordIds, const int wordId) const = 0;
