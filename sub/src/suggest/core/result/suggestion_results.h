...
class SuggestionResults {
 public:
...
#ifdef FLAG_IOS
    void outputSuggestions(int * outSuggestionCount,
    ...
    void addPrediction(const int *const codePoints, const int codePointCount, const int score, const int timestamp);
