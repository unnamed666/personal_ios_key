...
############ some local flags
# If you change any of those flags, you need to rebuild both libjni_latinimecm_common_static
# and the shared library that uses libjni_latinimecm_common_static.
FLAG_IOS ?= false
FLAG_DBG ?= false
...
ifeq ($(FLAG_IOS), true)
    LOCAL_CFLAGS += -DFLAG_IOS
endif # FLAG_IOS

LOCAL_MODULE := libjni_latinimecm_common_static
...
LOCAL_WHOLE_STATIC_LIBRARIES := libjni_latinimecm_common_static
...
LOCAL_MODULE := libjni_latinimecm
LOCAL_MODULE_TAGS := optional
