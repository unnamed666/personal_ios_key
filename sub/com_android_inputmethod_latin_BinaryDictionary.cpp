...
static void latinime_BinaryDictionary_getSuggestions(JNIEnv *env, jclass clazz, jlong dict,
        ...
        jobject outSampledData, jintArray outTimestampArray) {
    Dictionary *dictionary = reinterpret_cast<Dictionary *>(dict);
    ...
    int oldVersion = givenSuggestOptions.getDictOldVersion();
    if(oldVersion != 0) {
        int dictVersion = dictionary->getDictionaryStructurePolicy()->getHeaderStructurePolicy()->getVersion();
        AlgorithmSwitch::getInstance().setUseNewAlgorithm(dictVersion > oldVersion);
    }
    ...
    if (givenSuggestOptions.isGesture() || inputSize > 0) {
        ...
        if(givenSuggestOptions.isGestureLogOpen() &&
                givenSuggestOptions.isGesture()) {
            traverseSession->intGestureSampledData(env, outSampledData, inputSize);
        }
    } else {
    ...
    suggestionResults.outputSuggestions(env, outSuggestionCount, outCodePointsArray,
            ...
            outAutoCommitFirstWordConfidenceArray, inOutWeightOfLangModelVsSpatialModel, outTimestampArray);
}
...
static const JNINativeMethod sMethods[] = {
    ...
    {
            /*Lpanda/keyboard/emoji/gesture/GestureSampledData;*/
        const_cast<char *>("getSuggestionsNative"),
        const_cast<char *>("(JJJ[I[I[I[I[II[I[[I[ZI[I[I[I[I[I[I[FLpanda/keyboard/emoji/gesture/GestureSampledData;[I)V"),
