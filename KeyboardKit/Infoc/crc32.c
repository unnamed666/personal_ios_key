 ...
 */
local const unsigned int crc_table[TBLS][256] =
{
  {
...
/* ========================================================================= */
#define DO1 crc = crc_table[0][((unsigned int)crc ^ (*buf++)) & 0xffU] ^ (crc >> 8)
...
#define DOLIT4 c ^= *buf4++; \
        c = crc_table[3][c & 0xffU] ^ crc_table[2][(c >> 8) & 0xffU] ^ \
            crc_table[1][(c >> 16) & 0xffU] ^ crc_table[0][c >> 24]
...
#define DOBIG4 c ^= *++buf4; \
        c = crc_table[4][c & 0xffU] ^ crc_table[5][(c >> 8) & 0xffU] ^ \
            crc_table[6][(c >> 16) & 0xffU] ^ crc_table[7][c >> 24]
